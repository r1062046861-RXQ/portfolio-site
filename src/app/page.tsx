        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              {
                title: "网页设计与交互开发",
                desc: "提供从视觉设计到前端开发的定制化网页解决方案，打造极具设计感与商业价值的数字交互平台。",
                tags: ["网页设计", "前端开发", "UI/UX"]
              },
              {
                title: "游戏开发与互动体验",
                desc: "基于游戏引擎开发 3D 互动体验与独立游戏，结合数字艺术打造跨媒介的新型交互娱乐形式。",
                tags: ["独立游戏", "3D 交互", "引擎开发"]
              }
            ].map((service, idx) => (
              <TiltWrapper 
                key={idx}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 md:gap-6">
            {[
              ...
              },
              {
                ...
                project: "生态艺术季装置",
                category: "可持续公共艺术",
                desc: "在自然林木间落地《一帘幽梦》等可持续装置，将废旧工业材料与植物结合，构建自然与人文对话的疗愈场域。",
                image: "/images/88.png"
              },
              {
                client: "非物质文化遗产",
              ...
              },
              {
                ...
                project: "《桃源秘境》商业展",
                category: "商业文旅与民艺",
                desc: "策划并落地结合藏南民艺与岭南元素的沉浸式商业文化展览，将大地叙事转化为可体验的户外探索产品与空间装置。",
